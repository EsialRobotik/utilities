...
import web.handler.SettingsHandler;
import web.handler.FileHandler;
import web.handler.PlayHandler;
import web.handler.ReadHandler;
import web.handler.RecordHandler;
import web.handler.StopHandler;
...
public class AX12Http implements HttpHandler {
	...
	public void handle(HttpExchange t) throws IOException {
        ...
        if (!requestedFile.getAbsolutePath().startsWith(this.staticContentFolder.getAbsolutePath())) {
